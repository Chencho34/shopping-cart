...
export default function SliderItem ({ src, title, subtitle, paragraph, children, buttons }: SliderItemProps): JSX.Element {
  return (
    <section className='h-[370px] w-full overflow-hidden relative rounded-b-xl flex items-end bg-center bg-contain' style={{backgroundImage: `linear-gradient(to bottom, rgba(154, 146, 146, 0.624), rgba(35, 32, 32, 0.7)), url(${src})`}}>
