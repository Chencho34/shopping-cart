        ...
        <section className='w-full py-12'>
          <div className='grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_500px]'>
            <img
              ...
              height='550'
            />
            <Fade className='flex' direction='left'>
              ...
              <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
                <div className='flex flex-col items-center justify-center space-y-2'>
                  <figure className='relative flex h-20 w-20 shrink-0 overflow-hidden rounded-full'>
                    <img src='/images/yareth.jpeg' alt='img-yareth' />
                  </figure>
                ...
                <div className='flex flex-col items-center justify-center space-y-2'>
                  <figure className='relative flex h-20 w-20 shrink-0 overflow-hidden rounded-full'>
                    <img src='/images/david.jpeg' alt='img-david' className='w-full'/>
                  </figure>
                  <div className='text-center'>
                ...
                <div className='flex flex-col items-center justify-center space-y-2'>
                  <figure className='relative flex h-20 w-20 shrink-0 overflow-hidden rounded-full'>
                    <img src='/images/karime.jpeg' alt='img-karime' />
                  </figure>
                  <div className='text-center'>
                ...
                <div className='flex flex-col items-center justify-center space-y-2'>
                  <figure className='relative flex h-20 w-20 shrink-0 overflow-hidden rounded-full'>
                    <img src='/images/armando.jpeg' alt='img-armando' />
                  </figure>
                  <div className='text-center'>
