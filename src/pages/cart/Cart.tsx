...
export default function Cart (): JSX.Element {
  ...
  return (
    <div className='h-screen w-full bg-center bg-no-repeat fixed overflow-y-auto top-0 right-0 bottom-0 left-0 bg-cover bg-[url("/images/hero-02.webp")]' style={{background: ''}}>
